...
- **This isn't a hypothetical risk.** [ToolHazard](https://arxiv.org/abs/2608.11878) (August 2026) tested this exact threat model at a much larger scale than this chapter's single vendor notice, 28 synthesized environments, 512 tools, and found every frontier model in its lineup still gets hijacked at meaningful rates, GPT-5 included. It also found that an injected instruction lands more often when it sits near the *end* of a tool's returned text rather than in the middle, worth keeping in mind if you ever write test documents like this chapter's yourself.
