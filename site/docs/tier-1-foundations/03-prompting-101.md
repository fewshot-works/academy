...
Full instructions: [`labs/tier1-foundations/03-prompt-playground`](https://github.com/fewshot-works/zero-to-agent/tree/main/labs/tier1-foundations/03-prompt-playground)
