...
0. **Set up your machine** — install the free tools every later lab depends on.
1. **What is AI?** — where generative AI fits inside AI and machine learning.
2. **What is an LLM?** — how a large language model predicts the next word.
3. **Prompting 101** — how phrasing changes what a model produces.
4. **What is an embedding?** — turning text into something a computer can compare.
5. **What is a vector database?** — storing and searching embeddings at scale.
6. **What is RAG?** — combining search and generation to answer questions about your own documents.
