  ...
  return (
    <Layout title={TITLE} description={META_DESCRIPTION}>
      <Head>
        <meta
          name="keywords"
          content="AI agent system design interview, agentic AI system design round, RAG system design interview questions"
        />
      </Head>
      <main className={styles.page}>
        <div className="container">
          <PageHeader
            ...
            backTo="/career-tracks/applied-agentic-ai-engineer"
            backLabel="Applied / Agentic AI Engineer"
          />
    ...
    E -->|"budget running low"| I["Graceful degradation\\n(cheaper model / narrower scope)"]`}
          ...
          <SubNav
            prev={{label: 'Back: the technical round', to: '/interview-prep/technical-round/applied-agentic-ai-engineer'}}
            next={{label: 'Next: the behavioral round', to: '/interview-prep/behavioral-round/applied-agentic-ai-engineer'}}
          />
        </div>
      </main>
    </Layout>
