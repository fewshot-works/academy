...
export default function CaseStudies(): ReactNode {
  return (
    ...
    G["Content-refresh pipeline\\n(phase 3)"] --> A`}
          ...
          <SubNav
            prev={{label: 'Back: the live design round', to: '/interview-prep/technical-round/ai-solutions-architect-presales'}}
            next={{label: 'Next: the behavioral round', to: '/interview-prep/behavioral-round/ai-solutions-architect-presales'}}
          />
        </div>
      </main>
    </Layout>
