...
export default function CaseStudies(): ReactNode {
  return (
      ...
      <main className={styles.page}>
        <div className="container">
          <PageHeader
            ...
            backTo="/career-tracks/forward-deployed-engineer"
            backLabel="Forward-Deployed Engineer"
          />
    ...
    I -->|"confirmed / false positive"| J["Feedback loop\\nimproves future scoring"]`}
          ...
          <SubNav
            prev={{label: 'Back: the technical round', to: '/interview-prep/technical-round/forward-deployed-engineer'}}
            next={{label: 'Next: the behavioral round', to: '/interview-prep/behavioral-round/forward-deployed-engineer'}}
          />
        </div>
      </main>
    </Layout>
