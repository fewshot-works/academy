...
export default function ProductSense(): ReactNode {
  return (
    ...
    G --> H["Commit to error threshold\\n+ automated alert"]`}
          ...
          <SubNav
            prev={{label: 'Back: the technical round', to: '/interview-prep/technical-round/ai-product-manager'}}
            next={{label: 'Next: the behavioral round', to: '/interview-prep/behavioral-round/ai-product-manager'}}
          />
        </div>
      </main>
    </Layout>
