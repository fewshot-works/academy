...
export default function IncidentResponse(): ReactNode {
  return (
    ...
    I --> J`}
          ...
          <SubNav
            prev={{label: 'Back: the technical round', to: '/career-tracks/sre-reliability-engineer/technical-round'}}
            next={{label: 'Next: the behavioral round', to: '/career-tracks/sre-reliability-engineer/behavioral-round'}}
          />
        </div>
      </main>
    </Layout>
