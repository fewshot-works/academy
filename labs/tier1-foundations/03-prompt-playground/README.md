...
Companion lab for [Chapter 3: Prompting 101](https://fewshot-works.github.io/zero-to-agent/docs/tier-1-foundations/prompting-101). You'll ask an AI model to classify the same product review three different ways (zero-shot, few-shot, and with a system prompt) and compare the answers.
...
1. **Move into this lab folder.** If you already cloned the repo for an earlier lab, just `cd` into this one:
   ...
   ```bash
   cd zero-to-agent/labs/tier1-foundations/03-prompt-playground
   ```
