...
Hands-on labs for the zero-prior-knowledge track. Each numbered folder corresponds to one chapter in the [site](../../site) (Chapter 0 setup guide through the Foundations capstone).
...
- [`08-capstone-qa-bot`](./08-capstone-qa-bot): Chapter 8 lab, the Foundations capstone, a reusable Q&A bot over a whole folder of your own documents, saved to disk between runs.

Chapter 7 is concept-only, no lab. That completes Foundations, the Intermediate track picks up next.

Every lab in this track runs with **either**:
